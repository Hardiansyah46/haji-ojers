...
// Jika URL: /haji-ojers/olahraga/piala-dunia-u20-resmi-dibuka
if(isset($segments[1])) {
    $page = $segments[1]; // kategori atau page
}
if(isset($segments[2])) {
    $slug = $segments[2]; // slug artikel
}
?>
<!DOCTYPE html>
<html lang="id">
<head>
  ...
  <link rel="stylesheet" href="/haji-ojers/css/style.css">
  ...
  <nav class="navbar" x-data="{ open: false, search: false }">
    <div class="navbar-container">
      ...
      <div :class="{'active': open}" class="navbar-center" id="mobileMenu">
        <a href="<?= $base ?>">Home</a>
        <a href="<?= $base ?>/olahraga">Olahraga</a>
        <a href="<?= $base ?>/opini">Opini</a>
        <a href="<?= $base ?>/berita">Berita</a>
...
?>
  ...
  <footer>
    ...
    <div class="footer-links">
      <a href="<?= $base ?>/privacy-policy">Kebijakan Privasi</a>
      <a href="<?= $base ?>/contact-us">Kontak Kami</a>
    </div>
